...
CIridiumRocketProjectile = Class(SingleCompositeEmitterProjectile) {
    ...
    FxImpactUnit = SDEffectTemplate.T2RocketBotMissileHit,  ##RKS_EXPLOSIONS
    FxImpactProp = SDEffectTemplate.T2RocketBotMissileHit,  ##RKS_EXPLOSIONS  Changing so that many rocket hits don't lag the game. Also looks better =)
    FxImpactLand = SDEffectTemplate.T2RocketBotMissileHitGround,  ##RKS_EXPLOSIONS
    FxImpactUnderWater = {},
}
